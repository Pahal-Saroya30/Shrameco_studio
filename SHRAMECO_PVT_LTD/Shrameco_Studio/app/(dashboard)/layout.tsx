...
import { LiveNotificationPoller } from '@/components/LiveNotificationPoller';
...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
	...
	return (
		<SidebarProvider>
			<div className="min-h-screen bg-[#F9FAFB] flex flex-row font-sans text-slate-900 w-full">
				<AppSidebar />
